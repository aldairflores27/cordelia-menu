const items = [
  {
    ...
    price: 160,
    // ← URL directa extraída de tu enlace de Google Maps
  ...
  { cat: 'Tostadas', name: 'Atún Sellado', desc: 'Ajonjolí, salsa de soya cítrica', price: 95, img: '' },
  { cat: 'Cocteles', name: 'Coctel Campechano', desc: 'Pulpo y camarón en salsa especial', price: 150, img: '' },
    ...
    <section className="max-w-7xl mx-auto px-4 py-16" id="menu">
      ...
      <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((it)=> (
          ...
          >
            {/* Imagen por URL (si no pones link, usa placeholder) */}
            <img
              ...
              className="h-40 w-full object-cover rounded-xl mb-3 border border-white/10"
            />
